...
<Listing number="21-22" file-name="src/lib.rs" caption="Попытка джойнить потоки при дропе пула">
...
<Listing number="21-23" file-name="src/lib.rs" caption="Явно дропаем sender перед ожиданием потоков">
...
<Listing number="21-24" file-name="src/lib.rs" caption="Выходим из цикла, если recv вернул ошибку">
...
<Listing number="21-25" file-name="src/main.rs" caption="Сервер выключается после двух запросов">
